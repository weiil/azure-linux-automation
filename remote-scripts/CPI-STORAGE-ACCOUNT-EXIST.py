...
def create_storage_account():
    ...
    return random_storage_account_name, storage_account_type


def Update_cf_manifest(source_yml_file, destination_yml_file, random_storage_account_name, storage_account_type):
    ...
    out['jobs'][0]['name'] = 'exist_storage_account_name'
...
def RunTest():
    ...
    random_storage_account_name, storage_account_type = create_storage_account()
    Update_cf_manifest(source_manifest_name, destination_manifest_name, random_storage_account_name, storage_account_type)
    if DeployCF(destination_manifest_name):
        vm_name = Run('bosh vms --details | grep exist_storage_account_name | awk \'{print $13}\'')
...
destination_manifest_name = 'cpi-storage-account-exist-cf.yml'
cf_deployment_name = 'storage-account-exist-cf'
