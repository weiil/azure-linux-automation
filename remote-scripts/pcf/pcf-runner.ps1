...
RunLinuxCmd -username $userName -password $passwd -ip $publicIP -port $port -command "./prepare-pcf-infrastructure-on-azure.sh params.json 2&> prepare-pcf-infrastructure-on-azure.log"
# get ops man FQDN
